  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-primary/3 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
          ...
          <div className="relative p-8 h-full flex flex-col justify-between">
            ...
            <div className="absolute bottom-8 right-8">
              <div className="w-12 h-12 rounded-full border border-border/80 bg-background flex items-center justify-center text-muted-foreground group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary transition-all duration-300">
        ...
        >
          ...
          <div className="absolute top-0 right-0 p-8 text-muted-foreground/20 group-hover:text-primary/30 group-hover:scale-110 transition-all duration-500 pointer-events-none">
            <PenLine className="w-16 h-16" strokeWidth={1.5} style={{ transform: 'translate(10%, -10%)' }} />
          </div>

          <div>
            <div className="flex items-center gap-2 text-muted-foreground mb-2">
              <span className="w-2 h-2 rounded-full bg-primary/80 shadow-[0_0_8px_rgba(59,130,246,0.5)]" />
        ...
        <div className="md:col-span-12 rounded-[1.5rem] border border-border/40 bg-background/20 p-8 relative mt-2">
              ...
              return (
                <div key={i} className="relative group">
                  <div className="flex flex-col gap-4">
                    <div className="w-12 h-12 rounded-full bg-card border border-border/60 flex items-center justify-center shrink-0 text-muted-foreground group-hover:border-primary/40 group-hover:text-primary group-hover:scale-110 group-hover:shadow-[0_0_15px_rgba(59,130,246,0.2)] transition-all shadow-sm relative z-10">
