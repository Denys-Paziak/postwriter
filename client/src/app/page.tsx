  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-teal-500/5 to-emerald-500/5 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
          ...
          <div className="relative p-8 h-full flex flex-col justify-between">
            ...
            <div className="absolute bottom-8 right-8">
              <div className="w-12 h-12 rounded-full border border-border/80 bg-background flex items-center justify-center text-muted-foreground group-hover:bg-foreground group-hover:text-background group-hover:border-foreground transition-all duration-300">
        ...
        <div className="md:col-span-4 rounded-[1.5rem] bg-card border border-border/50 p-8 flex flex-col justify-between relative overflow-hidden group">
          <div className="absolute top-0 right-0 p-8 text-muted-foreground/30 group-hover:text-muted-foreground/50 transition-colors">
            <PenLine className="w-24 h-24" strokeWidth={1} style={{ transform: 'translate(20%, -20%)' }} />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:col-span-12">
          ...
          <div className="rounded-2xl bg-background border border-border/50 p-6 flex items-center justify-between group hover:border-border transition-colors">
            <div>
              <p className="text-sm font-medium text-muted-foreground mb-1">Збережені статті</p>
              <p className="text-3xl font-bold tabular-nums">{stats.totalArticles}</p>
            </div>
            <div className="w-12 h-12 rounded-full bg-card flex items-center justify-center text-muted-foreground group-hover:text-foreground transition-colors border border-border/40">
          ...
          <div className="rounded-2xl bg-background border border-border/50 p-6 flex items-center justify-between group hover:border-border transition-colors">
            <div>
              ...
              <p className="text-3xl font-bold tabular-nums">{stats.totalPlanned}</p>
            </div>
            <div className="w-12 h-12 rounded-full bg-card flex items-center justify-center text-muted-foreground group-hover:text-foreground transition-colors border border-border/40">
          ...
          <div className="rounded-2xl bg-background border border-border/50 p-6 flex items-center justify-between group hover:border-border transition-colors">
            <div>
              ...
              <p className="text-3xl font-bold tabular-nums">{stats.totalPublished}</p>
            </div>
            <div className="w-12 h-12 rounded-full bg-card flex items-center justify-center text-muted-foreground group-hover:text-foreground transition-colors border border-border/40">
              ...
              return (
                <div key={i} className="relative group">
                  <div className="flex flex-col gap-4">
                    <div className="w-12 h-12 rounded-full bg-card border border-border/60 flex items-center justify-center shrink-0 text-muted-foreground group-hover:border-foreground/30 transition-colors shadow-sm relative z-10">
